...
const Dropdown2 = () => {
    ...
    return (
        <div className="app-navbar-item" id="kt_header_user_menu_toggle">
            <button
                className="btn btn-flat p-0 rounded-pill text-white text-start d-flex align-items-center"
                type="button"
            ...
            >
                    ...
                    {/* Ikon dropdown */}
                    <i className="bi bi-caret-down-fill dropdown-icon text-white"></i>
                </div>
            </button>
            <ul className="dropdown-menu">
                ...
                <li>
                    ...
                    >
                        <i className='bi bi-arrow-right'></i>&nbsp;&nbsp;Keluar
                    </Link>
                </li>
            </ul>
        </div>
